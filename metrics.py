...
# Here is the code of all the metrics that are being used for the current experiments.
Please note few of the metrics are just given or might be not used. Thanks to https://github.com/shalabh147/Brain-Tumor-Segmentation-and-Survival-Prediction-using-Deep-Neural-Networks/blob/master/metrics.py for some metrices code.
"""
